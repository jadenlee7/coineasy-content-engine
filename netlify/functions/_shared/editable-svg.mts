...
function remixSvg(brand: Brand, spec: NormalizedSpec, assets: EditableCardAssets): string {
  ...
  const visual = assets.sourceImage
    ? `<rect id="Original-Visual-Background" x="0" y="78" width="1080" height="632" fill="#111820"/>${imageLayer("Original-Visual", assets.sourceImage, 0, 78, 1080, 632)}<rect id="Original-Visual-Shade" x="0" y="78" width="1080" height="632" fill="#05080C" fill-opacity="0.18"/>`
    : `<rect id="Original-Visual-Placeholder" x="0" y="78" width="1080" height="632" fill="#17242B"/><text id="Original-Visual-Placeholder-Text" x="540" y="402" text-anchor="middle" fill="#FFFFFF" fill-opacity="0.45" font-family="Inter, sans-serif" font-size="24">ORIGINAL VISUAL</text>`;
  return `<rect id="Canvas-Background" width="1080" height="1080" fill="${brand.dark}"/>
  <g id="Original-Visual-Layer">${visual}</g>
  <g id="Header"><rect id="Header-Background" width="1080" height="78" fill="${brand.dark}"/><rect id="Origin-Pill" x="34" y="18" width="202" height="42" rx="21" fill="#FFFFFF" fill-opacity="0.05" stroke="#FFFFFF" stroke-opacity="0.2"/><circle id="Origin-Pill-Dot" cx="56" cy="39" r="5" fill="${brand.primary}"/><text id="Origin-Pill-Text" x="73" y="44" fill="#FFFFFF" font-family="Inter, sans-serif" font-size="12" font-weight="700" letter-spacing="1.5">ORIGINAL VISUAL REMIX</text><rect id="Logo-Chip" x="918" y="14" width="128" height="50" rx="14" fill="#FFFFFF" fill-opacity="0.05" stroke="#FFFFFF" stroke-opacity="0.18"/>${logoLayer(brand, assets.logoDark, 926, 21, 112, 36, "#FFFFFF")}</g>
  <g id="Korea-GTM-Panel"><rect id="Panel-Background" x="0" y="710" width="1080" height="370" fill="${brand.dark}"/><rect id="Panel-Accent" x="44" y="710" width="992" height="5" rx="2.5" fill="${brand.primary}"/>
    ...
    <text id="Edit-Note" x="1036" y="763" text-anchor="end" fill="#FFFFFF" fill-opacity="0.5" font-family="Inter, sans-serif" font-size="12" font-weight="700" letter-spacing="2.4">KOREA GTM EDIT</text>
