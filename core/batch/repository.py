...
class SupabaseBatchRepository:
    ...
    async def fail_job(
        ...
        *,
        ...
        await self._rpc("fail_agent_batch_job", {
            "target_workspace_id": self.workspace_id,
            "target_job_id": _uuid(job_id, "job_id"),
            "target_expected_batch_id": provider_batch_id,
            "target_error_code": error_code,
            "target_retryable": retryable,
            "target_available_at": available_at.isoformat() if available_at else None,
