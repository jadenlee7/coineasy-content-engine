...
- **Banner localization:** treat the official creative as the final composition. Translate only meaningful visible copy into concise natural Korean. Never place Korean text on top of source lettering. When the source copy is in the lower third, crop away that text-bearing strip and place Korean in a separate Squid-dark footer without a box or blurred patch; otherwise preserve the source and place the translation below it. Keep the source line count and rhythm; a short repeated Latin keyword may remain when it carries the original visual. When the creative has no translatable copy, preserve the character and artwork without adding a headline, badge, footer, CTA, or duplicate logo.
